...
full.std <- clabc.step(num, 2, obs, tol, "banana", "full", b=B)
...
# standard (pair)
obs <- matrix(0, nrow=1, ncol=2, byrow=TRUE)
pair.std <- clabc.step(num, 2, obs, tol, "banana", "pair", b=B)
...
# rotated (full)
obs <- matrix(0, nrow=1, ncol=2, byrow=TRUE)
full.rot <- clabc.step(num, 2, obs, tol, "banana.rot", "full", b=B)
...
pair.rot <- clabc.step(num, 2, obs, tol, "banana.rot", "pair", b=B)
